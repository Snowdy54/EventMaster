            ...
            <section class="tab-pane active" id="events">
                <div class="slider-view" id="slider-view">
                    ...
                    <div class="event-slider-2">
                        <img src="{{ asset('img/may-walk.png') }}" alt="Майская прогулка">
                        <img src="{{ asset('img/art-masters.png') }}" alt="ArtMasters">
                        <img src="{{ asset('img/career-time.png') }}" alt="Время Карьеры">
                        <img src="{{ asset('img/day-life.png') }}" alt="День. Жизнь. Вечность.">
                        <img src="{{ asset('img/mediaprom.png') }}" alt="Медиапром">
                    </div>
                    <h2>Прошедшие события:</h2>
                    <div class="event-slider">
                        <img src="{{ asset('img/may-walk-profile.png') }}" data-event="may-walk" alt="Майская прогулка">
                        <img src="{{ asset('img/art-masters-profile.png') }}" data-event="art-masters" alt="ArtMasters">
                        <img src="{{ asset('img/culture-time-profile.png') }}" data-event="culture-time" alt="Время Карьеры">
                        <img src="{{ asset('img/day-life-profile.png') }}" data-event="day-life" alt="День. Жизнь. Вечность.">
                        <img src="{{ asset('img/mediaprom-profile.png') }}" data-event="mediaprom" alt="Медиапром">
                    </div>
                </div>
